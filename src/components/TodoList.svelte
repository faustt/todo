...
<div class="flex flex-col p-4 relative gap-2">
    ...
    {#if isEditing}
        <button
            class="bg-gray-100 flex flex-row gap-2 py-2 px-4 rounded focus:outline-none border-2 border-gray-200 focus:border-yellow-400 active:border-yellow-500 active:bg-yellow-400 active:text-white"
...
<button
    class="fixed bottom-14 right-0 m-6 w-16 h-16 rounded-full {isEditing
        ? 'bg-green-500'
        : 'bg-yellow-400'} focus:outline-none text-white flex items-center justify-center shadow-lg"
